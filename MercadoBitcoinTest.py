...
print (api.ticker())
print (api.ticker_litecoin())
print (api.orderbook())
print (api.orderbook_litecoin())
print (api.trades())
print (api.trades_tid('123'))
print (api.trades_since('123'))
print (api.trades_timestamp_inicial('123456789'))
print (api.trades_between('123456789', '987654321'))
print (api.trades_litecoin())
print (api.trades_litecoin_tid('123'))
print (api.trades_litecoin_since('123'))
print (api.trades_litecoin_timestamp_inicial('123456789'))
print (api.trades_litecoin_between('123456789', '987654321'))
